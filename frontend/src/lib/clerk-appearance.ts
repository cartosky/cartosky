...
export const clerkAppearance: NonNullable<ClerkProviderProps["appearance"]> = {
  ...
  elements: {
    ...
    logoImage: "!h-16 !max-h-16 !w-auto !max-w-[16rem]",
    ...
    userProfileRoot: "bg-[#08182a] text-white",
    userProfileCard: "bg-[#08182a] text-white shadow-none",
    userProfilePage: "bg-[#08182a] text-white",
    pageScrollBox: "bg-[#08182a] text-white",
