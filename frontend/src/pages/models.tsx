...
const MODEL_REFERENCE: Record<string, ModelReference> = {
  ...
  aifs: {
    eyebrow: "Core Model",
    oneLiner: "AI-based ECMWF global guidance sourced from the same open-data stream, now rolled out with surface temperature, dew point, total precip, total snowfall, and 10m wind speed.",
    coverage: "Global",
    cadence: "Every 6 hours",
    focus: [
