  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center px-6">
        <div className="glass-overlay flex min-w-[10rem] flex-col items-center gap-3 rounded-[1.6rem] px-5 py-4 text-center shadow-[0_18px_48px_rgba(0,0,0,0.22)]">
          <div className="relative h-10 w-10">
            <div className="absolute inset-0 rounded-full border border-white/12" />
            <div className="absolute inset-0 rounded-full border-2 border-transparent border-t-cyan-300/90 border-r-cyan-200/60 animate-spin" />
          </div>
          <div className="text-[10px] font-semibold uppercase tracking-[0.24em] text-white/54">
            {status}
          </div>
        </div>
      </div>
