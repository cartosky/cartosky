...
| 5 — re-run Layers 1-4 | **Layers 1-4 complete** (2026-07-04, see below) | **Layers 1-4 complete** (2026-07-04, see below) |
| 6 — add to `CARTOSKY_BINARY_SAMPLING_MODELS` | Not yet — gated on Phase C evidence + retroactivity check | Not yet — gated on Phase C evidence + retroactivity check |
